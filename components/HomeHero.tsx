    ...
    return (
        <section id="hero">
            <div className="container mx-auto relative">
                {/* Content Words */}
                <div
                    className="flex justify-center h-[15vh] items-center mx-auto w-[70%] md:w-[55%] md:h-[35vh] 3xl:w-[80%]">
                    <h1 className="text-white text-center font-medium text-[13px] md:text-[24px] 3xl:text-[50px] font-['Lato']
                     tracking-[.04rem]">
